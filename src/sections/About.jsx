...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("patrykkonior4@gmail.com");
        setHasCopied(true);
        setTimeout(() => {
            setHasCopied(false);
        },2000)
            ...
            <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
                ...
                <div className="xl:col-span-2 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            <p className="grid-headtext">
                                Jedną z moich pasji jest programowanie
                            </p>
                            <p className="grid-subtext">
                                Rozwiązywanie łamigłówek oraz tworzenie nowoczesnych aplikacji sprawia mi wiele radości
                                oraz satysfakcji. Na codzień rozwijam swoje umiejętności aby tworzyć oprogramowanie na
                                najwyższym poziomie.
                            </p>
                        </div>
                    </div>
